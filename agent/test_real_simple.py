#!/usr/bin/env python3
"""
Teste com dados reais mas simplificados
"""
import requests
import json

def test_real_simple():
    """Testa com dados reais mas simplificados"""
    ...
    # Dados baseados nos reais mas simplificados
    data = {
        ...
        'laboratorio_id': 1,
        'dados_hash': 'real_simple_test_123',
    }
    
    print("Testando dados reais simplificados...")
